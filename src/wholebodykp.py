...
class WholeBodyKp(DataModule):
    ...
    def cli(cls, parser: argparse.ArgumentParser):
        ...
        eval_set_group.add_argument('--wholebodykp-eval-test2017', default=False, action='store_true')
        eval_set_group.add_argument('--wholebodykp-eval-testdev2017', default=False, action='store_true')
